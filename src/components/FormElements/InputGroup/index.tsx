...
const InputGroup: React.FC<InputGroupProps> = ({
  ...
  handleChange,
  icon,
  style, // Ajout de style ici
  ...props
}) => {
  const id = useId();

  return (
    <div className={className}> {/* Application du style */}
      <label
        htmlFor={id}
      ...
      >
        <input
          ...
          style={style} // Application du style ici aussi
          className={cn(
            `w-full 
            rounded-lg 
            border-[1.5px] 
...
function getFileStyles(variant: "style1" | "style2") {
  switch (variant) {
    case "style1":
      return `file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke file:bg-[#E2E8F0] file:px-3 file:py-2 file:text-body-sm file:font-medium file:text-dark-5 file:hover:bg-primary file:hover:bg-opacity-10 dark:file:border-dark-3 dark:file:bg-white/30 dark:file:text-white`;
    default:
